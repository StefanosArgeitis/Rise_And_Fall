...
public class ElectroMini : MonoBehaviour
{
    ...
    public static event HandleElectroCollected OnElectroCollected;
    public delegate void HandleElectroCollected(ItemData itemData);
    ...
    private void Win(){
     ...
     public IEnumerator MinigameOffWin(){
        ...
        yield return new WaitForSeconds(mini_off_time);
        ResetMinigame();
        OnElectroCollected?.Invoke(itemData);
